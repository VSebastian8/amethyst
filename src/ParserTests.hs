...
machine1, machine2, machine3, machine4, machine5, machine6, machine7, machine8 :: Maybe (Leftover, Either Error Automata)
machine1 = runParser machinePE (Leftover auto1 0 0)
machine2 = runParser machinePE (Leftover auto2 0 0)
machine3 = runParser machinePE (Leftover auto3 0 0)
machine4 = runParser machinePE (Leftover auto4 0 0)
machine5 = runParser machinePE (Leftover auto5 0 0)
machine6 = runParser machinePE (Leftover auto6 0 0)
machine7 = runParser machinePE (Leftover auto7 0 0)
machine8 = runParser machinePE (Leftover auto8 0 0)

mc1, mc2, mc3, mc4, mc5, mc6, mc7, mc8, mc9, mc10, mc11, mc12, mc13, mc14 :: Maybe (Leftover, Either Error Automata)
