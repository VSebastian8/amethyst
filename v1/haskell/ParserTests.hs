...
st1, st2, st3, st4, st5, st6, st7, st8, st9, st10, st11, st12, st13, st14 :: Maybe (Leftover, Either Error State)
...
st10 = runParser statePE (Leftover state10 0 0)
st11 = runParser statePE (Leftover state11 0 0)
st12 = runParser statePE (Leftover state12 0 0)
st13 = runParser statePE (Leftover state13 0 0)
st14 = runParser statePE (Leftover state14 0 0)
